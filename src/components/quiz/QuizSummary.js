...
class QuizSummary extends Component {
    ...
    componentDidMount() {
        ...
        const numberOfAnsweredQuestions = searchParams.get('numberOfAnsweredQuestions');
        const correctAnswers = searchParams.get('correctAnswers');
        const wrongAnswers = searchParams.get('wrongAnswers');
        const hintsUsed = searchParams.get('hintsUsed');
        const fiftyFiftyUsed = searchParams.get('fiftyFiftyUsed');
        // if (state) {
        //     this.setState({
        ...
        //         fiftyFiftyUsed: state.wrongAnswers,
