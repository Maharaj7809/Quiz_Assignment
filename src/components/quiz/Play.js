...
class Play extends Component {
    ...
    endGame = () => {
        ...
        //     // navigate('/play/quizSummary', playerStats);
        //     window.location.href = '/play/quizSummary';
        // }, 1000);
        const queryString = Object.entries(playerStats)
            .map(([key, value]) => `${encodeURIComponent(key)}=${encodeURIComponent(value)}`)
            .join('&');

        const url = `/play/quizSummary?${queryString}`;
